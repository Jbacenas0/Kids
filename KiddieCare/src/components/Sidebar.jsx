...
const Sidebar = () => {
  ...
  return (
    <div className="w-16 md:w-56 fixed left-0 top-0 z-10 h-screen border-r pt-8 px-4 bg-aqua ">
      {/* Logo Section */}
      <div className="mb-5">
      ...
      <ul className="mt-8 space-y-6">
        {SIDEBAR_LINKS.map((link) => (
          <li key={link.id} 
          className={'font-medium rounded-md py-2 px-2 hover:bg-green-100 hover:text-indigo-500 ${activeLink === index ? "bg-indigo-500": ""} '}>
